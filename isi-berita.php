			...
			<div class="col-md-12 blog-box">
				...
				?>
					<div class="post-content">
					 <h2><?php echo $v['judul_berita']; ?></h2>
						 <ul class="post-meta">
						   <li><?php echo tgl_indo($v['tgl_berita']); ?></li>
						 </ul>
						 
						 <center><img style="width:150px; height:150px;" src="admin/uploads/img_berita/<?php echo $v['foto']; ?>"></center><br>
						 <p style="text-align:justify">&emsp;&emsp;<?php echo $v['p1']; ?></p>
						 <p style="text-align:justify">&emsp;&emsp;<?php echo $v['p2']; ?></p>
						 <p style="text-align:justify">&emsp;&emsp;<?php echo $v['p3']; ?></p>
						 <p style="text-align:justify">&emsp;&emsp;<?php echo $v['p4']; ?></p>
