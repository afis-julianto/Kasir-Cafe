...
function UploadImage($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../uploads/img_berita/";
...
// BUAT MENU //////////////////////////////////////////////////////
function UploadMenu($fupload_name){
  //direktori gambar
  $vdir_upload = "../../uploads/img_menu/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
// BUAT TOKO //////////////////////////////////////////////////////
function UploadToko($fupload_name){
  //direktori gambar
  $vdir_upload = "../../uploads/img_toko/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
// BUAT Galery //////////////////////////////////////////////////////
function UploadGalery($fupload_name){
  //direktori gambar
  $vdir_upload = "../../uploads/img_galery/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadSlider($fupload_name){
  //direktori gambar
  $vdir_upload = "../../uploads/img_slider/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadPartner($fupload_name){
  //direktori gambar
  $vdir_upload = "../../uploads/img_partner/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
